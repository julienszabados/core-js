...
```
* `{Array, %TypedArray%}#includes` [proposal](https://github.com/tc39/Array.prototype.includes) - module [`esnext.array.includes`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.array.includes.js), `%TypedArray%` version in modules from [this section](#ecmascript-6-typed-arrays).
```js
Array
...
```
* `Object.values`, `Object.entries` [proposal](https://github.com/tc39/proposal-object-values-entries) - modules [`esnext.object.values`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.values.js), [`esnext.object.entries`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.entries.js)
```js
Object
  .values(object) -> array
...
```
* `Object.getOwnPropertyDescriptors` [proposal](https://github.com/tc39/proposal-object-getownpropertydescriptors) - module [`esnext.object.get-own-property-descriptors`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.get-own-property-descriptors.js)
```js
Object
...
```
* `String#padStart`, `String#padEnd` [proposal](https://github.com/tc39/proposal-string-pad-start-end) - modules [`esnext.string.pad-start`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.string.pad-start.js), [`esnext.string.pad-end`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.string.pad-end.js)
```js
String
...
```
* `Object#__(define|lookup)[GS]etter__`, [annex B ES2017](https://github.com/tc39/ecma262/pull/381), but we haven't special namespace for that - modules [`esnext.object.define-setter`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.define-setter.js), [`esnext.object.define-getter`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.define-getter.js), [`esnext.object.lookup-setter`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.lookup-setter.js) and [`esnext.object.lookup-getter`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.object.lookup-getter.js).
```js
Object
...
```
* `global` [proposal](https://github.com/tc39/proposal-global) - modules [`esnext.global`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.global.js)
```js
global -> object
```
[*CommonJS entry points:*](#commonjs)
...
```
* `Promise#finally` [proposal](https://github.com/tc39/proposal-promise-finally) - module [`esnext.promise.finally`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.promise.finally.js)
```js
Promise
...
```
* `Symbol.asyncIterator` for [async iteration proposal](https://github.com/tc39/proposal-async-iteration) - module [`esnext.symbol.async-iterator`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.symbol.async-iterator.js)
```js
Symbol
...
```
* `Promise.try` [proposal](https://github.com/tc39/proposal-promise-try) - module [`esnext.promise.try`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.promise.try.js)
```js
Promise
...
```
* `Array#flatten` and `Array#flatMap` [proposal](https://tc39.github.io/proposal-flatMap) - modules [`esnext.array.flatten`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.array.flatten.js) and [`esnext.array.flat-map`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.array.flat-map.js)
```js
Array
...
```
* `.of` and `.from` methods on collection constructors [proposal](https://github.com/tc39/proposal-setmap-offrom) - modules [`esnext.set.of`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.weak-map.from.js)
```js
Set
  .of(...args) -> set
...
```
* `String#matchAll` [proposal](https://github.com/tc39/String.prototype.matchAll) - module [`esnext.string.match-all`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.string.match-all.js)
```js
String
...
```
* `Observable` [proposal](https://github.com/zenparsing/es-observable) - modules [`esnext.observable`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.symbol.observable.js)
```js
...
* `Math.{clamp, DEG_PER_RAD, degrees, fscale, rad-per-deg, radians, scale}` 
  ...
  [`esnext.math.clamp`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.clamp.js), 
  [`esnext.math.DEG_PER_RAD`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.DEG_PER_RAD.js), 
  [`esnext.math.degrees`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.degrees.js),
  [`esnext.math.fscale`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.fscale.js), 
  [`esnext.math.RAD_PER_DEG`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.RAD_PER_DEG.js), 
  [`esnext.math.radians`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.radians.js) and
  [`esnext.math.scale`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.scale.js)
```js
Math
  .DEG_PER_RAD -> number
  .RAD_PER_DEG -> number
...
```
* `Math.signbit` [proposal](http://jfbastien.github.io/papers/Math.signbit.html) - module [`esnext.math.signbit`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.signbit.js)
```js
Math
  .signbit(x) -> bool
```
...
```
* `String#at` [proposal](https://github.com/mathiasbynens/String.prototype.at) - module [`esnext.string.at`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.string.at.js)
```js
String
  #at(index) -> string
```
...
'a𠮷b'.at(1).length; // => 2
```
* `Math.{iaddh, isubh, imulh, umulh}` [proposal](https://gist.github.com/BrendanEich/4294d5c212a6d2254703) - modules [`esnext.math.iaddh`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.iaddh.js), [`esnext.math.isubh`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.isubh.js), [`esnext.math.imulh`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.imulh.js) and [`esnext.math.umulh`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.math.umulh.js)
```js
Math
...
```
* `glogal.asap`, [TC39 discussion](https://github.com/rwaldron/tc39-notes/blob/master/es6/2014-09/sept-25.md#510-globalasap-for-enqueuing-a-microtask), module [`esnext.asap`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.asap.js)
```js
asap(fn) -> void
```
[*CommonJS entry points:*](#commonjs)
...
```
* `Reflect` metadata [proposal](https://github.com/jonathandturner/decorators/blob/master/specs/metadata.md) - modules [`esnext.reflect.define-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/esnext.reflect.metadata.js).
```js
Reflect
