...
```
* `global` [proposal](https://github.com/tc39/proposal-global) - modules [`es7.global`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/es7.global.js)
```js
global -> object
```
[*CommonJS entry points:*](#commonjs)
...
```
#### Object
Modules [`core.object.is-object`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/core.object.is-object.js) and [`core.object.classof`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/core.object.classof.js)
```js
Object
  .isObject(var) -> bool
  .classof(var) -> string
...
```
#### Escaping strings
Modules [`core.string.escape-html`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/core.string.escape-html.js) and [`core.string.unescape-html`](https://github.com/zloirock/core-js/blob/v2.5.0/modules/core.string.unescape-html.js).
```js
String
  #escapeHTML() -> str
  #unescapeHTML() -> str
